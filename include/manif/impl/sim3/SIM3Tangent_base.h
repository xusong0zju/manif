...
template <typename _Derived>
void SIM3TangentBase<_Derived>::zero()
{
  coeffs().setZero();
}

template <typename _Derived>
void SIM3TangentBase<_Derived>::random()
{
  coeffs().setRandom();
}

template <typename _Derived>
typename SIM3TangentBase<_Derived>::Manifold
...
template <typename _Derived>
typename SIM3TangentBase<_Derived>::Jacobian
SIM3TangentBase<_Derived>::adj() const
{
...
template <typename _Derived>
typename SIM3TangentBase<_Derived>::BlockV
SIM3TangentBase<_Derived>::v()
{
  return coeffs().template head<3>();
}

template <typename _Derived>
const typename SIM3TangentBase<_Derived>::ConstBlockV
SIM3TangentBase<_Derived>::v() const
{
  return coeffs().template head<3>();
}

template <typename _Derived>
typename SIM3TangentBase<_Derived>::BlockW SIM3TangentBase<_Derived>::w()
{
  return coeffs().template tail<3>();
}

template <typename _Derived>
const typename SIM3TangentBase<_Derived>::ConstBlockW
SIM3TangentBase<_Derived>::w() const
{
  return coeffs().template tail<3>();
}

//template <typename _Derived>
//typename SIM3TangentBase<_Derived>::Scalar
//SIM3TangentBase<_Derived>::x() const
//{
//  return data()->x();
//}
...
//template <typename _Derived>
//typename SIM3TangentBase<_Derived>::Scalar
//SIM3TangentBase<_Derived>::y() const
//{
//  return data()->y();
//}
...
//template <typename _Derived>
//typename SIM3TangentBase<_Derived>::Scalar
//SIM3TangentBase<_Derived>::z() const
//{
//  return data()->z();
//}
